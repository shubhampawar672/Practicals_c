...
//1.	Write a C program for Binary Tree to Binary Search Tree Conversion
#include <stdio.h>
#include <stdlib.h>
#define max 50
struct node
...
int main()
{
    struct node *newnode = createnode(32);
    newnode->left = createnode(11);
    newnode->right = createnode(6);
    newnode->left->left = createnode(98);
    newnode->left->right = createnode(46);
    newnode->right->left = createnode(22);
    newnode->right->right = createnode(51);
